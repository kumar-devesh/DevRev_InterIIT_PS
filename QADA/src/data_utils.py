...
def read_features_and_examples(args, file_name, tokenizer, logger, use_simple_feature=False, read_examples=False,
    ...
    if read_examples:
        ...
        examples = read_squad_examples(input_file=file_name, is_training=True, logger=logger, 
                version_2_with_negative=args.version_2_with_negatives)
        #except:
    ...
    try:
        ...
        features = convert_examples_to_features(
            ...
            is_training=True, use_simple_feature=use_simple_feature)
...
def read_squad_examples(input_file, is_training, logger, version_2_with_negative=True):
...
def read_squad_examples_with_multiple_answers(input_file, version_2_with_negative=True):
    """Read a SQuAD json file into a list of SquadExample."""
    with open(input_file, "r", encoding='utf-8') as reader:
        input_data = json.load(reader)["data"]
...
def write_predictions_qada(args, all_examples, all_features, all_results, n_best_size,
                      max_answer_length, do_lower_case, output_prediction_file,
                      output_nbest_file, output_null_log_odds_file, verbose_logging,
                      version_2_with_negative=True, null_score_diff_threshold=1.0, wr=True):
    """Write final predictions to the json file and log-odds of null if needed."""

    version_2_with_negative = args.version_2_with_negatives
    null_score_diff_threshold = args.null_score_threshold
    ...
    if wr:
        ...
        logger.info("getting preprocessing confidence scores for model trainingw")
