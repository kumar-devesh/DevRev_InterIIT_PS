...
parser.add_argument("--debug", default=False, help="run on a tiny subset")
...
parser.add_argument("--train_both", action='store_true', help="Whether to train on both train data, synthetic dev data")
...
parser.add_argument("--predict_file", default='./data/squad/dev-v2.0.json', type=str, help="SQuAD json for predictions. E.g., dev-v1.1.json.")
